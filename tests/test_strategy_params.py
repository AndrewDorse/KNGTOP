...
def test_rule_fires_close_up() -> None:
    r = MispriceRule("close_buy_up", cheap_max=CHEAP_PRICE_MAX, side="UP", kind="lose_dn")
...
def test_rule_fires_close_down() -> None:
    r = MispriceRule("close_buy_down", cheap_max=CHEAP_PRICE_MAX, side="DOWN", kind="lose_up")
